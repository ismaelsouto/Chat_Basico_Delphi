...
begin
  ...
  begin
    ...
    Memo1.Text := Memo1.Text + 'Servidor arrancado' + #13#10;
    Button2.Caption := 'Parar'; // Set the button caption
  end
...
begin
  ...
  Memo1.Text := Memo1.Text + 'Cliente' + IntToStr(Socket.SocketHandle) + ' :' +
